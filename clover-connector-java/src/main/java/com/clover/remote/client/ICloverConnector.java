...
public interface ICloverConnector extends Serializable {
   ...
   * entered.
   *
   * @param VerifySignatureRequest The rejected VerifySignatureRequest() the device passed 
...
/**
 ...
 /**
   ...
   *
   * <p>
   * <b>Note:</b> This request could cause the POS to miss a transaction or other 
   * information. 
